...
static void do_torrent_index( void );
static void do_torrent_file( void );
#ifdef HAVE_SCANDIR
...
check_torrent( void )
{
	int r1;
	char* file_bck;
	strcpy(file_bck,file);
	strcat(file_bck,".torrent");
	r1 = stat( file_bck, &sb );
	return r1;
}
